...
const HeroAnimatedBackground = () => {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-brand-card" aria-hidden>
      <div
      ...
      />
      <div
        className="absolute bottom-0 left-1/3 w-96 h-48 rounded-full bg-brand-canvas blur-2xl opacity-80"
      />
      <div className="hero-grid absolute inset-0 opacity-[0.35]" />
      <div className="absolute inset-0 bg-gradient-to-b from-brand-card via-transparent to-brand-canvas/50 pointer-events-none" />
    </div>
  )
}
