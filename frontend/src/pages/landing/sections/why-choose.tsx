            ...
            return (
              <RevealDiv key={item.title} delay={index * 0.05}>
                <div className="text-center">
                  <div className="mx-auto w-12 h-12 rounded-2xl bg-brand-card border border-brand-border shadow-sm flex items-center justify-center text-brand-accent mb-3">
                    <Icon className="w-6 h-6" strokeWidth={1.75} />
                  </div>
                  <h3 className="text-sm font-semibold text-brand-ink mb-1.5">
                    {item.title}
                  </h3>
